...
# Combines stable production deployment with optional experimental features.
...
AI_OPTIMIZATION=false      # Enable with 'true' when testing
CHAOS_TESTING=false        # Enable with 'true' when needed
DEPLOY_STRATEGY="rolling"  # Can change to 'canary' for experiments
DEPLOY_CLOUDS=("aws" "azure" "gcp")
